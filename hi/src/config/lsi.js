const Lsi = {
  appName: {
    cs: "Aplikace uuVideoLibrary",
    en: "Application uuVideoLibrary",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuVideoLibrary",
      en: "About application uuVideoLibrary",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuVideolibrary.",
      en: "You can buy your own uuVideolibrary.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuVideolibrary.",
      en: "You don't have rights to initialize this uuVideolibrary.",
    },
  },
